 ...
 */
class FilesystemIconViewMarcov1 extends TPage
{    
    private $iconview;
...
//  Constructor method
    public function __construct($param)
    {
        ...
        foreach ($dir as $fileinfo)
        {
         ...
         $this->iconview->addContextMenuOption('Open',   new TAction([$this, 'onOpen']),   'far:folder-open blue', $display_condition_open);
         $this->iconview->addContextMenuOption('Downlaod',   new TAction([$this, 'onDownload']),   'far:folder-open blue', $display_condition_download);
